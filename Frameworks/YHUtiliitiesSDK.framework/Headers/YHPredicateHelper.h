...
//  YHRongYiTong
//
//  Created by zxl on 2017/12/18.
//  Copyright © 2017年 YH. All rights reserved.
//

#import <Foundation/Foundation.h>

@interface YHPredicateHelper : NSObject

/**
 *  @author zxl, 15-03-30 10:03:03
 *
 *  正则表达式 http://www.cocoachina.com/bbs/read.php?tid=106586
 *验证数字：^[0-9]*$
 验证n位的数字：^\d{n}$
 验证至少n位数字：^\d{n,}$
 验证m-n位的数字：^\d{m,n}$
...
/**
 ...
 @return str
 */
+(BOOL)isSixNumWithString:(NSString *)string;
@end
